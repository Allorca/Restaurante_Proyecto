 ...
 */
class Version20180526112240 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE comanda ADD camarero_id INT DEFAULT NULL, DROP camarero, CHANGE precio precio NUMERIC(10, 2) DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE comanda ADD camarero LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, DROP camarero_id, CHANGE precio precio NUMERIC(10, 2) NOT NULL');
    }
}
